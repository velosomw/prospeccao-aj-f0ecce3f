...
export const PROSPECCAO_TOPICS: RmaTopic[] = [
  ...
  { id: 38, slug: "38-pendencia-prospeccao-anterior",                  label: "Informacaoções de pendência de Prospecção AJ anterior", group: "Outros" },
  { id: 39, slug: "39-outras-informacoes",                      label: "Outras Informacaoções", group: "Outros" },
...
export function getTopicBySlug(slug: string | null | undefined): RmaTopic | null {
  if (!slug) return null;
  return PROSPECCAO_TOPICS.find((t) => t.slug === slug) || null;
}
