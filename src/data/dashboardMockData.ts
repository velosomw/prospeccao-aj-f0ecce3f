import type { DashboardStats, ComplianceData, RiskData, NoprospeccaotiveReference, CriticalArea, TrendDataPoint, AuditDistribution } from "@/types/dashboard";
...
export const mockNoprospeccaotiveReferences: NoprospeccaotiveReference[] = [
  ...
  { id: "7", code: "NBC TA 700", type: "nbcta", description: "Foprospeccaoção da Opinião e Emissão do Relatório", auditsImpacted: 118, findingsRelated: 0 },
