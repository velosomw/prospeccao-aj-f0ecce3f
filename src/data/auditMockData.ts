...
export const defaultFindings: AuditFinding[] = [
  {
    ...
    noprospecçãotiveFramework: { cpc: "CPC 47", ifrs: "IFRS 15", nbcTa: "NBC TA 540" },
    riskLevel: "high",
    impactType: ["result", "disclosure"],
    technicalBasis: "A receita apresenta crescimento de 40% enquanto o caixa operacional peprospecçãonece estável, indicando possível reconhecimento antecipado.",
  ...
  },
  {
    ...
    noprospecçãotiveFramework: { cpc: "CPC 26", nbcTa: "NBC TA 570", legislation: "Lei 6.404/76" },
    riskLevel: "high",
  ...
  },
  {
    ...
    noprospecçãotiveFramework: { cpc: "CPC 26", nbcTa: "NBC TA 315" },
    riskLevel: "medium",
  ...
  },
  {
    ...
    findingType: "inconsistency",
    noprospecçãotiveFramework: { cpc: "CPC 26", ifrs: "IAS 1" },
    riskLevel: "medium",
    impactType: ["result"],
  ...
  },
  {
    ...
    noprospecçãotiveFramework: { cpc: "CPC 01", ifrs: "IAS 36", nbcTa: "NBC TA 500" },
    riskLevel: "medium",
    impactType: ["patrimonial"],
...
export const defaultReportSections: ReportSection[] = [
  ...
  { id: "2", title: "Escopo e Metodologia", content: "O trabalho foi conduzido com base nas Noprospecçãos Brasileiras de Contabilidade (NBC TA), abrangendo procedimentos substantivos e de conformidade.", includeOpinion: false },
...
export const defaultOnDemandContents: OnDemandContent[] = [
  ...
  { id: "2", type: "conclusion", title: "Conclusão de Auditoria", description: "Conclusão foprospecçãol conforme NBC TA 700/705", generated: false },
