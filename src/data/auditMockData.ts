...
export const defaultFindings: AuditFinding[] = [
  {
    ...
    noprospeccaotiveFramework: { cpc: "CPC 47", ifrs: "IFRS 15", nbcTa: "NBC TA 540" },
    riskLevel: "high",
    impactType: ["result", "disclosure"],
    technicalBasis: "A receita apresenta crescimento de 40% enquanto o caixa operacional peprospeccaonece estável, indicando possível reconhecimento antecipado.",
  ...
  },
  {
    ...
    noprospeccaotiveFramework: { cpc: "CPC 26", nbcTa: "NBC TA 570", legislation: "Lei 6.404/76" },
    riskLevel: "high",
  ...
  },
  {
    ...
    noprospeccaotiveFramework: { cpc: "CPC 26", nbcTa: "NBC TA 315" },
    riskLevel: "medium",
  ...
  },
  {
    ...
    findingType: "inconsistency",
    noprospeccaotiveFramework: { cpc: "CPC 26", ifrs: "IAS 1" },
    riskLevel: "medium",
    impactType: ["result"],
  ...
  },
  {
    ...
    noprospeccaotiveFramework: { cpc: "CPC 01", ifrs: "IAS 36", nbcTa: "NBC TA 500" },
    riskLevel: "medium",
    impactType: ["patrimonial"],
