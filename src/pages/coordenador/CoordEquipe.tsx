...
const team = [
  { nome: "Ana Silva",      email: "ana@bex.com",      prospeccaos: 12, score: 87, sla: 96, status: "Ativo" },
  { nome: "Carlos Mendes",  email: "carlos@bex.com",   prospeccaos: 9,  score: 74, sla: 90, status: "Ativo" },
  { nome: "Fernanda Costa", email: "fernanda@bex.com", prospeccaos: 7,  score: 91, sla: 98, status: "Ativo" },
  { nome: "Rafael Souza",   email: "rafael@bex.com",   prospeccaos: 5,  score: 62, sla: 84, status: "Sobrecarga" },
  { nome: "Julia Pereira",  email: "julia@bex.com",    prospeccaos: 4,  score: 80, sla: 92, status: "Ativo" },
];
...
export default function CoordEquipe() {
  const totalProspeccaos = team.reduce((s, t) => s + t.prospeccaos, 0);
            ...
            {team.map(t => {
              ...
              return (
                <tr key={t.email} className="border-t hover:bg-muted/20">
                  ...
                  <td className="px-4 py-3 font-semibold">{t.prospeccaos}</td>
