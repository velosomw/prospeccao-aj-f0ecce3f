...
const aprovacoes = [
  { id: "RMA-0012", empresa: "DIPLOMATA",  consultor: "Ana Silva",      score: 87, sla: "Vence hoje", periodo: "05/2026", critico: true },
  { id: "RMA-0014", empresa: "TECNOMAX",   consultor: "Carlos Mendes",  score: 72, sla: "Vence hoje", periodo: "04/2026", critico: true },
  { id: "RMA-0009", empresa: "BENTOIA",    consultor: "Fernanda Costa", score: 91, sla: "Vence em 1d", periodo: "05/2026" },
  { id: "RMA-0011", empresa: "MOVAG",      consultor: "Rafael Souza",   score: 41, sla: "Vence em 2d", periodo: "05/2026" },
  { id: "RMA-0008", empresa: "CONSTRUTEX", consultor: "Julia Pereira",  score: 78, sla: "Vence em 3d", periodo: "04/2026" },
];
...
export default function CoordAprovacoes() {
  return (
    <ConsultorPageShell
      title="Aprovações" subtitle="RMAs aguardando sua revisão e assinatura."
      kpis={[
