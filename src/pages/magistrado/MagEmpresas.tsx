import { Building2, Briefcase, Award, AlertTriangle, TrendingUp } from "lucide-react";
import ConsultorPageShell from "@/components/consultor/PageShell";

const empresas = [
  { nome: "DIPLOMATA",  proc: "RJ-2024-0012", inicio: "12/03/2024", score: 87, status: "Saudável", credores: 142 },
  { nome: "TECNOMAX",   proc: "RJ-2024-0014", inicio: "08/04/2024", score: 72, status: "Atenção",  credores: 98  },
  { nome: "BENTOIA",    proc: "RJ-2024-0009", inicio: "22/02/2024", score: 91, status: "Saudável", credores: 64  },
  { nome: "MOVAG",      proc: "RJ-2023-0089", inicio: "11/11/2023", score: 41, status: "Crítico",  credores: 213 },
  { nome: "CONSTRUTEX", proc: "RJ-2023-0076", inicio: "05/09/2023", score: 78, status: "Saudável", credores: 87  },
];
...
export default function MagEmpresas() {
  return (
    <ConsultorPageShell
      title="Recuperandas" subtitle="Empresas em recuperação judicial sob sua jurisdição."
      kpis={[
        ...
        { label: "Críticas",    value: empresas.filter(e => e.status === "Crítico").length, hint: "Risco alto", icon: AlertTriangle, tone: "red" },
        { label: "Credores",    value: empresas.reduce((s, e) => s + e.credores, 0), hint: "Total habilitado", icon: Briefcase, tone: "purple" },
        ...
        <table className="w-full text-sm">
          <thead className="bg-muted/40 text-xs text-muted-foreground uppercase tracking-wider">
            <tr>
              ...
              <th className="text-left px-4 py-2.5">Credores</th>
            ...
            {empresas.map(e => {
              ...
              return (
                <tr key={e.proc} className="border-t hover:bg-muted/20">
                  ...
                  <td className="px-4 py-3 text-xs text-muted-foreground">{e.inicio}</td>
                  <td className="px-4 py-3 font-semibold">{e.credores}</td>
