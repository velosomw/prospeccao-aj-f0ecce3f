...
const events = [
  ...
  { id: "MH-399", tipo: "rma",       titulo: "RMA-0009 visualizado",            proc: "RJ-2024-0009", autor: "Magistrado", data: "Ontem" },
...
const typeMeta: Record<string, { icon: any; bg: string; fg: string; label: string }> = {
  ...
  rma:       { icon: FileText,      bg: "hsl(258,90%,96%)", fg: "hsl(258,90%,45%)", label: "RMA" },
};
  ...
  return (
    <ConsultorPageShell
      ...
      kpis={[
        ...
        { label: "RMAs Lidos",    value: 14, hint: "Análises",  icon: FileText,     tone: "blue" },
