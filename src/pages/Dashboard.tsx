...
export default function Dashboard() {
  return (
    <ProfileHome
      ...
      summary={[
        { label: "Prospecções AJ em andamento",    value: 24,  icon: Briefcase,     tone: "blue",   to: "/consultor/rmas" },
        { label: "Pendências críticas",  value: 7,   icon: AlertTriangle, tone: "red",    to: "/dashboard/aprovacoes" },
        { label: "Prospecções AJ finalizados",     value: 38,  icon: CheckCircle2,  tone: "green",  to: "/dashboard/historico" },
      ...
      avisos={[
        { icon: AlertTriangle, tone: "red",    title: "Prazo Prospecção AJ-0014 vence hoje",       sub: "TECNOMAX - Consultor: Ana Silva", time: "há 12 min" },
        ...
        { icon: CheckCircle2,  tone: "green",  title: "Prospecção AJ-0009 concluído",              sub: "BENTOIA - Aprovado por Coord.",    time: "há 4h" },
      ]}
    />
  );
}
