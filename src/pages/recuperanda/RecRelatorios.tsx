...
export default function RecRelatorios() {
  return (
    <ConsultorPageShell
      title="Meus Relatórios" subtitle="RMAs publicados sobre seu processo de recuperação."
      kpis={[
        { label: "Publicados",  value: rels.length, hint: "Total",       icon: CheckCircle2, tone: "green" },
        { label: "Score Atual", value: 87, hint: "Último RMA",           icon: Award,        tone: "green" },
        ...
        { label: "Próxima Entrega", value: "20/05", hint: "RMA Jun/2026",icon: FileBarChart, tone: "orange" },
      ]}
    >
      <div className="bg-white rounded-xl border">
        <div className="p-4 border-b"><h3 className="text-sm font-semibold">Histórico de RMAs</h3></div>
