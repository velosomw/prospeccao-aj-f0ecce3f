...
const roles: { role: UserRole; icon: typeof Shield; title: string; desc: string; color: string }[] = [
  { role: "coordenador", icon: Shield, title: "Coordenador", desc: "Revisão, aprovação e governança dos Prospecções.", color: "hsl(217,91%,50%)" },
  { role: "admjudicial", icon: Gavel, title: "Admjudicial", desc: "Administração das Recuperandas e Prospecções entregues.", color: "hsl(280,80%,55%)" },
  { role: "consultor", icon: Building2, title: "Consultor", desc: "Operação e acompanhamento dos Prospecções.", color: "hsl(38,92%,50%)" },
