...
interface Ev { id: string; tipo: "criacao"|"edicao"|"aprovacao"|"publicacao"|"rejeicao"; titulo: string; rma: string; usuario: string; data: string; hora: string; }

const events: Ev[] = [
  { id: "H-401", tipo: "publicacao", titulo: "RMA Maio/2026 publicado",       rma: "RMA-0012", usuario: "Consultor RMA",   data: "Hoje",       hora: "14:32" },
  { id: "H-400", tipo: "aprovacao",  titulo: "Aprovado pelo Coordenador",     rma: "RMA-0012", usuario: "Coordenador",     data: "Hoje",       hora: "13:10" },
  { id: "H-399", tipo: "edicao",     titulo: "Bloco 7 - DRE editado",         rma: "RMA-0014", usuario: "Consultor RMA",   data: "Hoje",       hora: "11:48" },
  { id: "H-398", tipo: "rejeicao",   titulo: "Bloco 5 reprovado - dados inconsistentes", rma: "RMA-0009", usuario: "Coordenador", data: "Ontem", hora: "17:20" },
  { id: "H-397", tipo: "edicao",     titulo: "Reprocessamento IA solicitado", rma: "RMA-0011", usuario: "Consultor RMA",   data: "Ontem",      hora: "15:02" },
  { id: "H-396", tipo: "criacao",    titulo: "Novo RMA criado",               rma: "RMA-0014", usuario: "Coordenador",     data: "07/05",      hora: "09:15" },
  { id: "H-395", tipo: "publicacao", titulo: "RMA Abril/2026 publicado",      rma: "RMA-0008", usuario: "Consultor RMA",   data: "06/05",      hora: "16:40" },
];
  ...
  return (
    <ConsultorPageShell
      ...
      kpis={[
        ...
        { label: "Publicações",   value: 47,  hint: "RMAs concluídos",  icon: CheckCircle2, tone: "green" },
