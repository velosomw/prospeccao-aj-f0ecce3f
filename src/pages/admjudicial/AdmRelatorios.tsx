...
const rels = [
  { id: "REL-104", titulo: "Prospeccao Maio/2026 - DIPLOMATA",  empresa: "DIPLOMATA",  status: "Publicado", score: 87, data: "Há 4h" },
  { id: "REL-103", titulo: "Prospeccao Abril/2026 - TECNOMAX",  empresa: "TECNOMAX",   status: "Publicado", score: 72, data: "Há 1d" },
  { id: "REL-102", titulo: "Prospeccao Maio/2026 - BENTOIA",    empresa: "BENTOIA",    status: "Em Revisão",score: 91, data: "Há 2d" },
  { id: "REL-101", titulo: "Prospeccao Maio/2026 - MOVAG",      empresa: "MOVAG",      status: "Rascunho",  score: 41, data: "Há 3d" },
];
...
export default function AdmRelatorios() {
  return (
    <ConsultorPageShell
      title="Relatórios" subtitle="Prospeccoes AJ publicados das recuperandas sob sua administração."
      kpis={[
