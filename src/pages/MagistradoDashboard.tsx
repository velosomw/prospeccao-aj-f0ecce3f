  ...
  return (
    <ProfileHome
      ...
      cards={[
        ...
        { label: "Prospeccoes AJ Recebidos", desc: "Prospeccoes aguardando sua análise.",          icon: FileText,      to: "/magistrado/prospecções",      tone: "purple" },
      ...
      summary={[
        ...
        { label: "Prospeccoes AJ a Analisar",    value: "07",  icon: FileText,      tone: "orange", to: "/magistrado/prospecções" },
      ...
      avisos={[
        { icon: AlertTriangle, tone: "red",    title: "Prospeccao AJ crítico aguardando despacho", sub: "MOVAG - há 3 dias", time: "Hoje" },
        { icon: FileText,      tone: "blue",   title: "Novo Prospeccao AJ recebido",               sub: "DIPLOMATA - Comp. 05/2026", time: "10:20" },
