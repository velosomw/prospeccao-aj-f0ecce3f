  ...
  return (
    <ProfileHome
      ...
      cards={[
        ...
        { label: "Prospecções AJ Recebidos", desc: "Prospecções aguardando sua análise.",          icon: FileText,      to: "/magistrado/prospecções",      tone: "purple" },
      ...
      summary={[
        ...
        { label: "Prospecções AJ a Analisar",    value: "07",  icon: FileText,      tone: "orange", to: "/magistrado/prospecções" },
