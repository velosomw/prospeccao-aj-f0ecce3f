  ...
  return (
    <ProfileHome
      ...
      cards={[
        ...
        { label: "RMAs Recebidos", desc: "RMAs aguardando sua análise.",          icon: FileText,      to: "/magistrado/rmas",      tone: "purple" },
      ...
      summary={[
        ...
        { label: "RMAs a Analisar",    value: "07",  icon: FileText,      tone: "orange", to: "/magistrado/rmas" },
      ...
      avisos={[
        { icon: AlertTriangle, tone: "red",    title: "RMA crítico aguardando despacho", sub: "MOVAG - há 3 dias", time: "Hoje" },
        { icon: FileText,      tone: "blue",   title: "Novo RMA recebido",               sub: "DIPLOMATA - Comp. 05/2026", time: "10:20" },
