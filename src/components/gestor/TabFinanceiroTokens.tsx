...
const REPORT_TYPES = [
  ...
  { key: "pre_relatorio",      label: "Revisão-Relatório RMA",            icon: FileSearch,    color: "hsl(190,70%,50%)",
  ...
  { key: "relatorio_final",    label: "Relatório RMA Final",                  icon: FileBarChart2, color: "hsl(38,90%,55%)",
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-5 gap-4">
        <KPI
          icon={FileText}
          label="Custo por Relatório RMA Final"
          ...
          <div className="border-t border-border p-5">
            <table className="w-full text-sm">
              <thead><tr className="border-b border-border">
                <th className="text-left py-2 font-semibold text-muted-foreground">Etapa do RMA</th>
              ...
              <tbody>
                ...
                <tr className="bg-[hsl(258,90%,66%)]/10">
                  <td className="py-2 font-bold">Total geral RMA</td>
