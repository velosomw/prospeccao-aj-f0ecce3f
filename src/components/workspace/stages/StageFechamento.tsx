    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-5 gap-3">
        ...
        <div className="bg-white border border-border rounded-lg p-4 text-center">
          <h3 className="text-[11px] font-semibold text-muted-foreground uppercase tracking-wide mb-2">RMA Score Final</h3>
      ...
      {showReport && (
        <div className="bg-white border border-border rounded-lg p-4">
          <div className="flex items-center justify-between mb-3">
            <h3 className="text-sm font-bold text-foreground">Relatório RMA Final</h3>
