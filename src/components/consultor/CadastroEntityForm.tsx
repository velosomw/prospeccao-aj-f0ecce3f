...
export default function CadastroEntityForm({
  ...
  return (
    ...
    >
      ...
      {/* Site */}
      <Field label="Site" name="site" placeholder="https://www.exemplo.com.br" type="url" />

      {/* Razão Social / CNPJ */}
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        <Field label={razaoLabel} name="razao_social" placeholder="Digite a razão social" required />
        <Field label="CNPJ" name="cnpj" placeholder="00.000.000/0000-00" required />
      </div>

      {/* Responsável / Telefone */}
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        <Field label="Responsável" name="responsavel" placeholder="Digite o nome do responsável" />
        <Field label="Telefone" name="telefone" placeholder="(00) 00000-0000" />
      </div>

      {/* Dados do Contato */}
      <div>
        <h3 className="text-base font-bold text-[hsl(217,91%,40%)] mb-4">Dados do Contato</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          <Field label="E-mail do contato" name="contato_email" placeholder="exemplo@dominio.com.br" type="email" />
          <Field label="Nome do contato" name="contato_nome" placeholder="Digite o nome do contato" />
          <Field label="Telefone do contato" name="contato_telefone" placeholder="(00) 00000-0000" />
        </div>
      </div>
