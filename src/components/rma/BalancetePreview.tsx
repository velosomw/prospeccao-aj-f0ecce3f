...
const BalancetePreview = ({ companyId, rmaId }: Props) => {
      ...
      {empty && !loading && (
        <Card className="border-dashed">
          <CardContent className="py-12 text-center text-sm text-muted-foreground">
            ...
            Execute <b>Atualizar Status IA</b> na aba Status RMA para extrair e consolidar a partir dos arquivos do OneDrive.
          </CardContent>
        </Card>
      )}
